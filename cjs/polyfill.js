...
import { DEFAULT_ALLOWED_ELEMENTS, sanitizeDocFragment, _normalizeConfig } from "../src/sanitizer.js";
/**
...
function setup() {
  ...
  const GLOBALNAME = "Sanitizer"; // name of the innerHTML-setter,
...
setup(); // module.exports = Sanitizer